...
// tipos de parametros
// QUERY: ... (sempre são nomeados, são usados geralmente para filtros) ex: page=2
// ROUTE: ...  (uma identifcação de um recuros) ex: localhost:3333/ads/5
// BODY: ... (varias informações numa unica requisição)
